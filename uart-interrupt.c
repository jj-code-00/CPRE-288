...
volatile char command_byte; // byte value for special character used as a command
...
void uart_interrupt_init(void){
  ...
  uint16_t fBRD = /*44; //*/floor((64 * fmod(16000000.0/(16 * 115200),1)) + .5);
  ...
  UART1_CTL_R = 0b001100000001; //0x1;
